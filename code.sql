...
INSERT INTO Payment (PaymentId, PayerId, PayeeId, AppGroupId, Amount, CurrencyId, PaymentDate, Note) VALUES (512, 101, 103, 202, 50.00, 'EUR', TO_DATE('2023-03-01','YYYY-MM-DD'), 'Drinks share');
INSERT INTO Payment (PaymentId, PayerId, PayeeId, AppGroupId, Amount, CurrencyId, PaymentDate, Note) VALUES (513, 102, 104, 202, 400.00, 'EUR', TO_DATE('2023-03-02','YYYY-MM-DD'), 'Concert tickets');
...
INSERT INTO Notification (NotificationId, PaymentId, RecipientId, NotificationText, NotificationTime, IsRead) VALUES (612, 512, 103, 'You have received a payment of 50.00 EUR from Mohammed Smith.', TO_TIMESTAMP('2023-03-01 14:30:00', 'YYYY-MM-DD HH24:MI:SS'), 'N');
INSERT INTO Notification (NotificationId, PaymentId, RecipientId, NotificationText, NotificationTime, IsRead) VALUES (613, 513, 104, 'You have received a payment of 400.00 EUR from Jimmy Page.', TO_TIMESTAMP('2023-03-02 16:45:00', 'YYYY-MM-DD HH24:MI:SS'), 'N');
...
---3.4
Select AG.GroupName,AU.FirstName as PayerFirstName, AU.LastName as payerLastName,AU2.FirstName as payeeFirstName, AU2.lastName as PayeeLastName,
	P.Amount, P.PaymentDate,AG.GroupName
From Payment P
Join AppGroup AG ON P.AppGroupId = AG.AppGroupId
